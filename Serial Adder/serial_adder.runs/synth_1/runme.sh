...
HD_PWD='D:/Assignment/Codes/Digital Design/serial_adder/serial_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log serial_adde.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source serial_adde.tcl
