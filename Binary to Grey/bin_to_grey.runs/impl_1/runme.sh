...
HD_PWD='C:/Users/itsmo/Downloads/DD Labs/bin_to_grey/bin_to_grey.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log src.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source src.tcl -notrace
