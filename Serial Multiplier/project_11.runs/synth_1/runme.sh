...
HD_PWD='D:/Assignment/Codes/Digital Design/project_11/project_11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log serial_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source serial_multiplier.tcl
