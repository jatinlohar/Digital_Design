...
HD_PWD='D:/Assignment/Codes/Digital Design/project_11/project_11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log serial_multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source serial_multiplier.tcl -notrace
