...
HD_PWD='D:/Assignment/Codes/Digital Design/adder_subs_comp/adder_subs_comp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_subs_comp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_subs_comp.tcl -notrace
