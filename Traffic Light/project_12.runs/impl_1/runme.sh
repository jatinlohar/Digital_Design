...
HD_PWD='D:/Assignment/Codes/Digital Design/project_12/project_12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log trafic_light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source trafic_light.tcl -notrace
