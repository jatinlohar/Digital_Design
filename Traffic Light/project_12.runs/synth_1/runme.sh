...
HD_PWD='D:/Assignment/Codes/Digital Design/project_12/project_12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trafic_light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trafic_light.tcl
